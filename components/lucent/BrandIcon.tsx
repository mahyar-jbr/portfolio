...
/**
 * BrandIcon — other companies' real marks, wherever the site names one: Gmail,
 * GitHub and LinkedIn on the contact tiles, a case study's code link, the tools
 * in a stack (ToolTag), the host of an event on an About caption. Mahyar,
 * 2026-09-23: "everywhere it can use the brand's icon it should use it."
 *
 * Every mark is in its owner's own colours, the full-colour version where there
 * is one. Mahyar, 2026-09-23: "its fine to use their own logo color, dont change
 * them, it gives the portfolio more soul."
 *
 * The kit's rule is "never hand-drawn copies of other companies' logos", and
...
interface Brand {
  /** The name as the content writes it. A label that names it gets the mark. */
  name: string;
  ...
  /**
   * Size against the other marks, so they read alike beside a word: solid
   * squares and discs sit a little smaller, thin or narrow marks a little
   * larger (set by eye from each mark's ink coverage).
   */
  optical?: number;
  /**
   * Gradients, masks and clip paths, for both versions. `{id}` stands for an id
   * unique to each copy, since a mark can appear several times on a page.
   */
  defs?: string;
  /** The mark in its owner's colours, as SVG markup in the box's units. */
  art: string;
...
const BRANDS = {
  ...
  python: {
    ...
    art: '<path fill="url(#{id}-b)" d="M 60.510156,6.3979729 C 55.926503,6.4192712 51.549217,6.8101906 47.697656,7.4917229 C 36.35144,9.4962267 34.291407,13.691825 34.291406,21.429223 L 34.291406,31.647973 L 61.103906,31.647973 L 61.103906,35.054223 L 34.291406,35.054223 L 24.228906,35.054223 C 16.436447,35.054223 9.6131468,39.73794 7.4789058,48.647973 C 5.0170858,58.860939 4.9078907,65.233996 7.4789058,75.897973 C 9.3848341,83.835825 13.936449,89.491721 21.728906,89.491723 L 30.947656,89.491723 L 30.947656,77.241723 C 30.947656,68.391821 38.6048,60.585475 47.697656,60.585473 L 74.478906,60.585473 C 81.933857,60.585473 87.885159,54.447309 87.885156,46.960473 L 87.885156,21.429223 C 87.885156,14.162884 81.755176,8.7044455 74.478906,7.4917229 C 69.872919,6.7249976 65.093809,6.3766746 60.510156,6.3979729 z M 46.010156,14.616723 C 48.779703,14.616723 51.041406,16.915369 51.041406,19.741723 C 51.041404,22.558059 48.779703,24.835473 46.010156,24.835473 C 43.23068,24.835472 40.978906,22.558058 40.978906,19.741723 C 40.978905,16.91537 43.23068,14.616723 46.010156,14.616723 z"/><path fill="url(#{id}-y)" d="M 91.228906,35.054223 L 91.228906,46.960473 C 91.228906,56.191228 83.403011,63.960472 74.478906,63.960473 L 47.697656,63.960473 C 40.361823,63.960473 34.291407,70.238956 34.291406,77.585473 L 34.291406,103.11672 C 34.291406,110.38306 40.609994,114.65704 47.697656,116.74172 C 56.184987,119.23733 64.323893,119.68835 74.478906,116.74172 C 81.229061,114.78733 87.885159,110.85411 87.885156,103.11672 L 87.885156,92.897973 L 61.103906,92.897973 L 61.103906,89.491723 L 87.885156,89.491723 L 101.29141,89.491723 C 109.08387,89.491723 111.98766,84.056315 114.69765,75.897973 C 117.49698,67.499087 117.37787,59.422197 114.69765,48.647973 C 112.77187,40.890532 109.09378,35.054223 101.29141,35.054223 L 91.228906,35.054223 z M 76.166406,99.710473 C 78.945884,99.710476 81.197656,101.98789 81.197656,104.80422 C 81.197654,107.63057 78.945881,109.92922 76.166406,109.92922 C 73.396856,109.92922 71.135156,107.63057 71.135156,104.80422 C 71.135158,101.98789 73.396853,99.710473 76.166406,99.710473 z"/>',
  },
  /* typescriptlang.org/branding asset pack, ts-logo-128.svg: the blue mark
     it asks for as the primary logo, its "TS" white. */
  typescript: {
    name: 'TypeScript',
    box: [0, 0, 128, 128],
    optical: 0.85,
  ...
  /* pydantic.dev /favicon/favicon.svg, in Pydantic's magenta. */
  pydantic: {
    name: 'Pydantic',
    box: [0.46, 0.17, 138.08, 119.65],
    optical: 1.05,
  ...
  react: {
    ...
    dark: '<circle r="2" fill="#58C4DC"/><g stroke="#58C4DC" stroke-width="1" fill="none"><ellipse rx="10" ry="4.5"/><ellipse rx="10" ry="4.5" transform="rotate(60)"/><ellipse rx="10" ry="4.5" transform="rotate(120)"/></g>',
  },
  /* Vercel's Next.js assets (vercel.com/geist/brands, nextjs-assets.zip):
  ...
  vite: {
    ...
    art: '<path fill="#863BFF" d="M25.9456 44.9383C25.2821 45.7827 23.925 45.3131 23.925 44.2403V33.9369C23.925 32.6875 22.9126 31.6751 21.6631 31.6751H10.287C9.36714 31.6751 8.83075 30.6346 9.36713 29.8871L16.8464 19.4157C17.917 17.9185 16.8464 15.8376 15.0046 15.8376H1.23731C0.317479 15.8376 -0.218913 14.7972 0.317475 14.0497L10.0134 0.4741C10.2266 0.176825 10.5692 0.000183105 10.9332 0.000183105H39.8271C40.7469 0.000183105 41.2833 1.04065 40.7469 1.78814L33.2676 12.2595C32.197 13.7567 33.2676 15.8376 35.1094 15.8376H46.4856C47.4291 15.8376 47.959 16.9255 47.3753 17.6687L25.9478 44.9404L25.9456 44.9383Z"/><g mask="url(#{id}-m)"><g filter="url(#{id}-f0)"><ellipse cx="5.50802" cy="14.7043" rx="5.50802" ry="14.7043" transform="matrix(0.00324134 0.999995 0.999995 -0.00324134 -4.46924 31.5157)" fill="#EDE6FF"/></g><g filter="url(#{id}-f1)"><ellipse cx="10.3995" cy="29.8514" rx="10.3995" ry="29.8514" transform="matrix(0.00324134 0.999995 0.999995 -0.00324134 -39.3281 7.88272)" fill="#EDE6FF"/></g><g filter="url(#{id}-f2)"><ellipse cx="5.50802" cy="30.4868" rx="5.50802" ry="30.4868" transform="matrix(0.00324134 0.999995 0.999995 -0.00324134 -40.4673 11.3212)" fill="#7E14FF"/></g><g filter="url(#{id}-f3)"><ellipse cx="5.50802" cy="30.5986" rx="5.50802" ry="30.5986" transform="matrix(0.00324134 0.999995 0.999995 -0.00324134 -35.8721 29.3204)" fill="#7E14FF"/></g><g filter="url(#{id}-f4)"><ellipse cx="5.50802" cy="30.5986" rx="5.50802" ry="30.5986" transform="matrix(0.00324134 0.999995 0.999995 -0.00324134 -34.3398 30.4693)" fill="#7E14FF"/></g><g filter="url(#{id}-f5)"><ellipse cx="14.0715" cy="22.0783" rx="14.0715" ry="22.0783" transform="matrix(0.0584509 -0.99829 -0.99829 -0.0584509 74.3486 26.8633)" fill="#EDE6FF"/></g><g filter="url(#{id}-f6)"><ellipse cx="3.47034" cy="21.5008" rx="3.47034" ry="21.5008" transform="matrix(-0.0172986 -0.99985 -0.99985 0.0172986 75.7944 18.0627)" fill="#7E14FF"/></g><g filter="url(#{id}-f7)"><ellipse cx="3.47034" cy="21.5008" rx="3.47034" ry="21.5008" transform="matrix(-0.0172986 -0.99985 -0.99985 0.0172986 75.7944 18.0627)" fill="#7E14FF"/></g><g filter="url(#{id}-f8)"><ellipse cx="0.386861" cy="8.97156" rx="4.40666" ry="29.1076" transform="rotate(39.5103 0.386861 8.97156)" fill="#7E14FF"/></g><g filter="url(#{id}-f9)"><ellipse cx="47.5226" cy="-6.09166" rx="4.40666" ry="29.1076" transform="rotate(37.8923 47.5226 -6.09166)" fill="#7E14FF"/></g><g filter="url(#{id}-f10)"><ellipse cx="41.4121" cy="6.3335" rx="5.9715" ry="9.66515" transform="rotate(37.8923 41.4121 6.3335)" fill="#47BFFF"/></g><g filter="url(#{id}-f11)"><ellipse cx="-1.87921" cy="38.3321" rx="4.40666" ry="29.1076" transform="rotate(37.8923 -1.87921 38.3321)" fill="#7E14FF"/></g><g filter="url(#{id}-f12)"><ellipse cx="-1.87921" cy="38.3321" rx="4.40666" ry="29.1076" transform="rotate(37.8923 -1.87921 38.3321)" fill="#7E14FF"/></g><g filter="url(#{id}-f13)"><ellipse cx="35.6511" cy="29.9069" rx="4.40666" ry="29.1076" transform="rotate(37.8923 35.6511 29.9069)" fill="#7E14FF"/></g><g filter="url(#{id}-f14)"><ellipse cx="38.4178" cy="32.4" rx="5.9715" ry="15.2974" transform="rotate(37.8923 38.4178 32.4)" fill="#47BFFF"/></g></g>',
  },
  /* tailwindcss.com/brand, tailwindcss-mark.svg, in sky #38BDF8 on both
  ...
  nodejs: {
    ...
    art: '<path fill="url(#{id}-main)" d="M22.8725 0.4166C22.136 0 21.2616 0 20.5253 0.4166L1.1505 11.6694C0.4142 12.0862 0 12.8733 0 13.707V36.2584C0 37.0921 0.4602 37.8791 1.1505 38.296L20.5253 49.5487C21.2616 49.9653 22.136 49.9653 22.8725 49.5487L42.2471 38.296C42.9836 37.8791 43.3976 37.0921 43.3976 36.2584V13.707C43.3976 12.8733 42.9375 12.0862 42.2471 11.6694L22.8725 0.4166Z"/><polygon fill="url(#{id}-r1)" clip-path="url(#{id}-c)" points="21.698901,-1.046618 43.20532,11.948247 21.698901,51.072715 0.152778,38.055107"/><polygon fill="url(#{id}-r2)" clip-path="url(#{id}-c)" points="21.698901,-1.046618 0.152778,11.948247 21.698901,51.072715 43.20532,38.055107"/>',
  },
  /* mongodb.com brand resources, logo-marks.svg: the leaf in Forest Green on
  ...
  /* vercel.com/geist/brands, vercel-assets.zip: icon/light (black) and
     icon/dark (white). */
  vercel: {
    name: 'Vercel',
    box: [0, 0, 1154.69, 1000],
    optical: 0.9,
  ...
  anthropic: {
    ...
    dark: '<path fill="#FAF9F5" d="M66.4915 0H52.5029L78.0115 64H92.0001L66.4915 0Z"/><path fill="#FAF9F5" d="M26.08 0L0.571472 64H14.8343L20.0512 50.56H46.7374L51.9543 64H66.2172L40.7086 0H26.08ZM24.6647 38.6743L33.3943 16.1829L42.1239 38.6743H24.6647Z"/>',
  },
  /* elevenlabs.io/brand, elevenlabs-symbol.svg: the "11" symbol in black,
  ...
  elevenlabs: {
    ...
    dark: '<path fill="#fff" d="M468 292H528V584H468V292Z"/><path fill="#fff" d="M348 292H408V584H348V292Z"/>',
  },
  /* twilio.com's own logo (core-assets/customer-logos/t-z/twilio.svg), the
     mark without the word, in Twilio red. */
  twilio: {
    name: 'Twilio',
    box: [0, 4, 40, 40],
    optical: 0.9,
  ...
  plotly: {
    name: 'Plotly',
    box: [0, 0, 108.97, 108.97],
    defs: '<linearGradient id="{id}-g" y1="23.35" x2="108.97" y2="23.35" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#ff2c6d"/><stop offset="0.4" stop-color="#cd74a6"/><stop offset="1" stop-color="#7fe4ff"/></linearGradient>',
    art: '<circle fill="url(#{id}-g)" cx="70.05" cy="38.92" r="7.78"/><circle fill="url(#{id}-g)" cx="101.19" cy="7.78" r="7.78"/><circle fill="url(#{id}-g)" cx="70.05" cy="7.78" r="7.78"/><circle fill="url(#{id}-g)" cx="38.92" cy="7.78" r="7.78"/><circle fill="url(#{id}-g)" cx="7.78" cy="7.78" r="7.78"/><circle fill="url(#{id}-g)" cx="7.78" cy="38.92" r="7.78"/><path fill="#282D33" d="M7.78,62.27A7.78,7.78,0,0,0,0,70.05v31.14a7.79,7.79,0,0,0,15.57,0V70.05A7.79,7.79,0,0,0,7.78,62.27Z"/><path fill="#282D33" d="M70.05,62.27a7.79,7.79,0,0,0-7.78,7.78v31.14a7.79,7.79,0,0,0,15.57,0V70.05A7.79,7.79,0,0,0,70.05,62.27Z"/><path fill="#282D33" d="M38.92,31.14a7.78,7.78,0,0,0-7.78,7.78v62.27a7.78,7.78,0,0,0,15.56,0V38.92A7.78,7.78,0,0,0,38.92,31.14Z"/><path fill="#282D33" d="M101.19,31.14a7.78,7.78,0,0,0-7.78,7.78v62.27a7.78,7.78,0,0,0,15.56,0V38.92A7.78,7.78,0,0,0,101.19,31.14Z"/>',
    dark: '<circle fill="url(#{id}-g)" cx="70.05" cy="38.92" r="7.78"/><circle fill="url(#{id}-g)" cx="101.19" cy="7.78" r="7.78"/><circle fill="url(#{id}-g)" cx="70.05" cy="7.78" r="7.78"/><circle fill="url(#{id}-g)" cx="38.92" cy="7.78" r="7.78"/><circle fill="url(#{id}-g)" cx="7.78" cy="7.78" r="7.78"/><circle fill="url(#{id}-g)" cx="7.78" cy="38.92" r="7.78"/><path fill="#fff" d="M7.78,62.27A7.78,7.78,0,0,0,0,70.05v31.14a7.79,7.79,0,0,0,15.57,0V70.05A7.79,7.79,0,0,0,7.78,62.27Z"/><path fill="#fff" d="M70.05,62.27a7.79,7.79,0,0,0-7.78,7.78v31.14a7.79,7.79,0,0,0,15.57,0V70.05A7.79,7.79,0,0,0,70.05,62.27Z"/><path fill="#fff" d="M38.92,31.14a7.78,7.78,0,0,0-7.78,7.78v62.27a7.78,7.78,0,0,0,15.56,0V38.92A7.78,7.78,0,0,0,38.92,31.14Z"/><path fill="#fff" d="M101.19,31.14a7.78,7.78,0,0,0-7.78,7.78v62.27a7.78,7.78,0,0,0,15.56,0V38.92A7.78,7.78,0,0,0,101.19,31.14Z"/>',
  },
  /* anaconda.com/docs, logo/light.svg and logo/dark.svg: the ring without the
  ...
  /* Hudl's own StatsBomb icon (static.hudl.com productAssets/statsbomb_icon.svg).
     StatsBomb's open data asks anyone publishing with it to use its logo. */
  statsbomb: {
    name: 'StatsBomb',
    box: [0, 0, 239.32, 239.31],
    optical: 0.85,
    art: '<path fill="#FF6300" fill-rule="evenodd" d="M19.945 0H219.38c11.016 0 19.942 8.929 19.942 19.942v199.427c0 11.014-8.926 19.942-19.942 19.942H19.945C8.93 239.311 0 230.382 0 219.369V19.942C0 8.93 8.93 0 19.945 0Z"/><path fill="#fff" d="M165.315 86.488c20.54 20.587 20.224 54.203-.703 75.13-20.926 20.926-54.554 21.243-75.13.703l-9.643 9.643s-.035-.035-.047-.035h.012c-25.766-25.766-25.39-68.065.832-94.3 26.223-26.222 68.533-26.597 94.299-.831l.047.046 10.463-10.463-.047-.047c-31.483-31.507-83.003-31.05-115.061 1.008-32.047 32.046-32.504 83.566-1.02 115.062 0 0 .035.035.047.035l10.463-10.464c12.49 12.479 29.176 19.228 46.927 19.076 17.775-.153 34.601-7.23 47.326-19.954 26.222-26.223 26.597-68.487.878-94.253l-9.643 9.644Z"/><path fill="#fff" d="M127.023 162.836c10.194-.093 19.943-4.136 27.313-11.506 15.115-15.115 15.349-39.498.516-54.379l-9.644 9.643c9.62 9.667 9.456 25.426-.339 35.245h-.012c-9.819 9.831-25.567 9.995-35.233.364l10.451-10.452s-.035-.035-.047-.035h.012c-3.972-3.996-3.913-10.499.129-14.553s10.557-4.101 14.529-.129c0 0 .012.024.024.035l-14.658 14.658c3.972 3.926 10.463 3.867 14.482-.175 4.019-4.019 4.101-10.499.176-14.483l10.451-10.451s-.035-.035-.035-.047c-9.667-9.667-25.449-9.526-35.292.316-9.83 9.831-9.971 25.625-.316 35.292 0 0 .023.012.035.024l-9.643 9.643c7.241 7.206 16.884 11.072 27.066 10.979l.035.011Z"/><path fill="#fff" d="M90.104 87.132c-20.938 20.939-21.243 54.602-.68 75.165 0 0 .036.035.048.035l10.463-10.463s-.035-.035-.047-.035h.012c-14.857-14.881-14.658-39.299.492-54.426 15.127-15.127 39.545-15.35 54.414-.492 0 0 .035.035.035.047L165.305 86.5s-.036-.036-.036-.047c-20.563-20.564-54.226-20.27-75.165.68Z"/>',
  },
} satisfies Record<string, Brand>;

export type BrandName = keyof typeof BRANDS;

/** How much of the icon's height the longest side of a mark fills, at optical 1. */
const FILL = 0.86;

/**
 * The mark centred in a box as tall as the icon, and only as wide as the mark,
 * so the gap to the word after it is the same for a leaf as for a whale.
 */
function viewBox({ box: [x, y, w, h], optical = 1 }: Brand): string {
  const side = Math.max(w, h);
  const height = side / (FILL * optical);
  const pad = (height - side) / 2;
...
export function brandFor(label: string): BrandName | undefined {
  const found = NAMES.flatMap(([key, pattern]) =>
    Array.from(label.matchAll(pattern), (m) => ({ key, start: m.index, end: m.index + m[0].length })),
  );
  const named = new Set(
    found
      .filter((a) => !found.some((b) => b.start <= a.start && a.end <= b.end && b.end - b.start > a.end - a.start))
      .map((a) => a.key),
  );
  return named.size === 1 ? [...named][0] : undefined;
}

export default function BrandIcon({ name, className }: { name: BrandName; className?: string }) {
  const brand: Brand = BRANDS[name];
  const id = `brand${useId().replace(/[^\w-]/g, '')}`;
  const markup = [
    brand.credit ? `<!-- ${brand.credit} -->` : '',
    brand.defs ? `<defs>${brand.defs}</defs>` : '',
    /* both versions are drawn; the theme shows one (styles/site.css "Brand icons") */
    brand.dark ? `<g class="brand-light">${brand.art}</g><g class="brand-dark">${brand.dark}</g>` : brand.art,
  ].join('');
  return (
    <svg
      className={className ? `brand-icon ${className}` : 'brand-icon'}
      viewBox={viewBox(brand)}
      aria-hidden="true"
      dangerouslySetInnerHTML={{ __html: markup.replace(/\{id\}/g, id) }}
    />
  );
}
