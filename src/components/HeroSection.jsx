      ...
      <div className="max-w-7xl w-full relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 text-white group-hover:text-black transition-colors duration-500 font-bold tracking-wider uppercase text-xs sm:text-sm">
              Explore Work
            </span>
          ...
          <motion.a
            ...
            className="group relative px-6 py-3 sm:px-10 sm:py-5 border-2 border-white bg-black overflow-hidden flex items-center gap-3"
            whileTap={{ scale: 0.98 }}
            whileHover={{ boxShadow: "0 0 30px rgba(255,255,255,0.3)" }}
          >
            {/* Sliding white background */}
